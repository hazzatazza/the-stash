			...
			M = function ()
			{
				...
				}, e.dispatchEvent = function (e, t)
				{
					...
					for (var o = Object.keys(this.listeners), r = 0; r < o.length; r++)
					{
						var a = o[r];
						if (e === a)
							for (var s = this.listeners[a], d = 0; d < s.length; d++) s[d](D(D(
							{}, this.videoDataAnnotations), t))
					}
				}, e.addVideoDataAnnotations = function (e)
				{
					this.videoDataAnnotations = D(D(
					{}, this.videoDataAnnotations), e)
				...
				function t(n)
				{
					...
					}, this.gameplayStart = function (n)
					{
						...
						else
						{
							...
							{
								var r;
								performance.now() - t.lastInteractionTime < 5e3 && (r = i.lastInteractionEvent), Li.track(e.tracking.screen.gameplayStart, Zn(Zn(
								{}, n),
								{
					...
					{
						i.ignoreEvents() ? T.debug && console.error("gameplayStop ignored because of too many events") : (i.duringGameplay = !1, Li.track(e.tracking.screen.gameplayStop, Zn(Zn(
						{}, t),
						{
							fps: i.fpsStats.stats()
					...
					{
						void 0 === o && (o = {}), t && n ? (t = String(t), n = String(n), o = Zn(
						{}, o), "game" === t && "segment" === n && o.segment && i.measure(o.segment), Li.track(e.tracking.custom,
						{
							eventNoun: t,
							eventVerb: n,
							eventData: o
				...
				window.pbjs.que.push((function ()
				{
					...
					0 === (null === (n = Object.keys(o.floors)) || void 0 === n ? void 0 : n.length) && (console.log("disabled floor module"), null == o || delete o.floors), window.pbjs.addAdUnits(function (e, t)
					{
						...
						for (var a = 0; a <= e.length; a++)
							for (var s = e[a], d = r[(null === (n = null == s ? void 0 : s.mediaTypes) || void 0 === n ? void 0 : n.video) ? "video" : "display"] ||
								{}, c = (null === (i = null == s ? void 0 : s.bids) || void 0 === i ? void 0 : i.length) - 1; c >= 0; c--)
							{
								var l = s.bids[c],
									u = Math.random();
		...
		var Sr = function ()
		{
			function t()
			{
				...
				}, this.requestHouseAd = function (t, n)
				{
					...
					{
						t.innerAdContainer.innerHTML = '<a href="'.concat(o.click_through_url, '" target="_blank"><img src="').concat(o.asset, '" alt="house ad" /></a>'), n.houseAdId = o.id, n.isEmpty = !1, Li.track(e.tracking.ads.display.impression, n), R(Er(Er(
						{}, i),
						{
							event: "impression"
						})), setTimeout((function ()
			...
			}, t.prototype.renderAd = function (e)
			{
				...
				var k = function ()
				{
					...
					}) : window.googletag.cmd.push((function ()
					{
						...
						e && e.opportunityId === r && (n.totalRefreshNumber[w.adUnitPath] || (n.totalRefreshNumber[w.adUnitPath] = 0), n.setupGPT(w, Er(Er(
						{}, s),
						{
		...
		var zr = function ()
			...
			Gr = function ()
			{
										...
										if (c && (m.setAdTimings(
											{
												...
												timePerTry: 7e3,
												startAdsAfter: 0
											}), a.customCriteria = zr(zr(
											{}, a.customCriteria),
											{
												force_ad: c
											})), m.criteria = zr(
											{}, a.customCriteria), m.ima = new fr(s), m.playerSkin.setupEvents(m), m.startStartAdsAfterTimerOnInit && Nr.startStartAdsAfterTimer(), m.waterfall = new Yo(m.ima,
											{
												timing: Nr,
												totalRetries: d
				...
				}, t.prototype.requestAd = function (t)
				{
					...
					if (Li.track(f === e.ads.position.rewarded ? e.tracking.screen.rewardedBreak : e.tracking.screen.commercialBreak, zr(zr(
						{}, t.rewardedKVs), v)), this.videoRequestInFlight) l && l(
					{
						type: e.ads.busy,
						rewardAllowed: !1
					});
						...
						if (this.displayOnly) L.dispatchEvent(e.ads.error, zr(zr(
						{}, v),
						{
						...
						{
							if (!this.sdkBooted) return L.dispatchEvent(e.ads.error, zr(zr(
							{}, v),
							{
								message: "Requesting ad on unbooted SDK"
							})), void this.sdkNotBootedButCalled();
							if ((g() || y()) && f !== e.ads.position.rewarded)
								if ("evoworld.io" !== ((null === (n = null === window || void 0 === window ? void 0 : window.location) || void 0 === n ? void 0 : n.hostname) || "")) return void L.dispatchEvent(e.ads.error, zr(zr(
								{}, v),
								{
							...
							if ((null === (o = null === (i = this.ima) || void 0 === i ? void 0 : i.isAdRunning) || void 0 === o ? void 0 : o.call(i)) || (null === (a = null === (r = this.waterfall) || void 0 === r ? void 0 : r.isRunning) || void 0 === a ? void 0 : a.call(r))) L.dispatchEvent(e.ads.busy, v);
								...
								if (f === e.ads.position.rewarded || Nr.requestPossible())
									if (f !== e.ads.position.rewarded && this.adSettings.countryExclusion.includes(S.country)) L.dispatchEvent(e.ads.limit, zr(zr(
									{}, v),
									{
									...
									{
										if (S.kioskMode) return f === e.ads.position.rewarded ? void this.runNonIMAVideoHouseAd() : void L.dispatchEvent(e.ads.limit, zr(zr(
										{}, v),
										{
											reason: e.info.messages.disabled
										}));
										if (this.strictConsentMode && !this.monetizationCoreLoaded) return f === e.ads.position.rewarded || T.debug ? void this.runNonIMAVideoHouseAd() : void L.dispatchEvent(e.ads.error, zr(zr(
										{}, v),
										{
											messaage: "Ad libraries not yet loaded"
										}));
										if (!this.ima || this.sdkImaError || this.IMARejected) f === e.ads.position.rewarded ? this.runNonIMAVideoHouseAd() : L.dispatchEvent(e.ads.error, zr(zr(
										{}, v),
										{
											message: "Bot, IMA or Adblocker error"
										}));
										else if (Qi()) L.dispatchEvent(e.ads.error, zr(zr(
										{}, v),
										{
											messaage: "No TCFv2 CMP detected, please contact developersupport@poki.com for more information"
										}));
										else if (Wi()) L.dispatchEvent(e.ads.error, zr(zr(
										{}, v),
										{
										...
										{
											var m = zr(zr(zr(
											{}, this.genericCriteria()), this.criteria),
											{
												position: f,
							...
							else L.dispatchEvent(e.ads.limit, zr(zr(
							{}, v),
							{
